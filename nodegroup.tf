...
# resource.aws_eks_node_group.spot_node_group.resources[0].autoscaling_groups[0].name
resource "aws_autoscaling_schedule" "spot_nodegroup_scale_up" {
  ...
  recurrence             = "0 3 * * *"
  autoscaling_group_name = resource.aws_eks_node_group.spot_node_group[0].resources[0].autoscaling_groups[0].name
}
